...
try:
    ...
    if settings.effective_database_url.startswith("sqlite"):
        ...
        try:
            import psycopg2
            print("SUCCESS: psycopg2 PostgreSQL driver is properly installed.")
        except ImportError:
        ...
        try:
            import aiosqlite
            print("WARNING: aiosqlite (SQLite driver) is installed in production environment!")
        except ImportError:
            print("SUCCESS: aiosqlite (SQLite driver) is not installed, as expected in production.")
    else:
