...
# Import functions from refactored locations for backwards compatibility
...
# Re-export the refactored function for backwards compatibility
# These functions are now imported from their respective modules above
